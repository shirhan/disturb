...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.find_id = function(id) {
        var _ref, option, found;
        found = false;
        _ref = this.results_data;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            option = _ref[_i];
    ...
    Chosen.prototype.edit_id = function(id, text) {
        var _ref, option, found,_i;
        found = false;
        _ref = this.results_data;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            option = _ref[_i];
            ...
            {
                found = true;
                this.form_field.options[_i].text = text;
                break;
            }
        }
